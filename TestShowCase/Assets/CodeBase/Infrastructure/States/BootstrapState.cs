...
namespace CodeBase.Infrastructure.States
{
	public class BootstrapState : IState
	{
		...
		private void RegisterServices()
		{
			...
			_services.RegisterSingle<ISkillService>(new SkillService(_services.Single<IStaticDataService>(), _services.Single<IRandomService>(),
			...
			_services.RegisterSingle<IUIFactory>(new UIFactory(
				...
				_services.Single<IPersistentProgressService>(),
				_services.Single<IAdsService>(), _services.Single<ISkillService>(), _services.Single<ITimerService>()));
